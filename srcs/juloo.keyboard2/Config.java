...
public final class Config
{
  ...
  private Config(SharedPreferences prefs, Resources res, IKeyEventHandler h)
  {
    ...
    labelTextSize = 0.33f + 1.67f * Math.abs( (_prefs.getInt("keyboard_height", 35) / 100.f) - 0.35f );//0.396f;//0.33f *+ 0.2
    sublabelTextSize = 0.22f + 1.67f * Math.abs( (_prefs.getInt("keyboard_height", 35) / 100.f) - 0.35f );//0.22f *+ 0.2
    try
    {
